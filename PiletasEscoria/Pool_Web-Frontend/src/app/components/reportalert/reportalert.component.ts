...
@Component({
  selector: 'app-reportalert',
  templateUrl: './reportalert.component.html',
  styleUrls: ['./reportalert.component.css']
})
export class ReportAlertComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,private globals: Globals,
    ...
    downLoadFile(data: any, type: string) {
      ...
      element.download = "MimicoPiletasEscoriaReportAlert_"+formattedDate+".xlsx";
    ...
    onSubmit() {
        ...
        var url1 = this.globals.baseUrl + '/poolAction/PoolAlertReport/'+this.reportForm.get("iDate").value+'/'+this.reportForm.get("eDate").value;
    ...
    download() {
      ...
      if (this.reportForm.invalid) {
        ...
        //var url1 = this.globals.baseUrl + '/poolAction/Alerts/'+this.reportForm.get("iDate").value+'/'+this.reportForm.get("eDate").value;
        var url1 = this.globals.baseUrl + '/poolAction/PoolReportExcel/'+this.reportForm.get("iDate").value+'/'+this.reportForm.get("eDate").value;
